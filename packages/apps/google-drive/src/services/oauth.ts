...
class GoogleDriveOauth extends OauthService {
  ...
  static getAppDetails(projectConfig,options) {
    ...
    return {
      ...
      description: "Google Drive is a free service from Google that allows you to store files online.",
      install_url: null,
      ...
      overview: "Google Drive is a free service from Google that allows you to store files online and access them anywhere using the cloud. Google Drive also gives you access to free web-based applications for creating documents, spreadsheets, presentations, and more.",
