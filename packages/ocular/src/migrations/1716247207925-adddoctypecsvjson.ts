...
export class Adddoctypecsvjson1716247207925 implements MigrationInterface {
    name = 'Adddoctypecsvjson1716247207925'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."document_metadata_type_enum_old" AS ENUM('pdf', 'txt', 'docx', 'html', 'md')`);
