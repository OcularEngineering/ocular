...
export class Addasana1709166537754 implements MigrationInterface {
    name = 'Addasana1709166537754'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."o_auth_app_name_enum" RENAME TO "o_auth_app_name_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."o_auth_app_name_enum" AS ENUM('asana', 'confluence', 'github', 'google-drive')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."app_name_enum" AS ENUM('asana', 'confluence', 'github', 'google-drive')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."app_category_enum" AS ENUM('Software Development', 'File Storage', 'Productivity')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."app_category_enum_old" AS ENUM('Software Development', 'File Storage')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."app_name_enum_old" AS ENUM('github', 'google-drive', 'confluence')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."o_auth_app_name_enum_old" AS ENUM('github', 'google-drive', 'confluence')`);
