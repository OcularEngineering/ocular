...
export class AddBitbucketAppDefinations1715194026789 implements MigrationInterface {
    name = 'AddBitbucketAppDefinations1715194026789'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "document_metadata" ALTER COLUMN "updated_at" DROP DEFAULT`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "document_metadata" ALTER COLUMN "updated_at" SET DEFAULT now()`);
        await queryRunner.query(`CREATE TYPE "public"."document_metadata_source_enum_old" AS ENUM('asana', 'confluence', 'github', 'gmail', 'google-drive', 'jira', 'notion', 'slack')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."app_name_enum_old" AS ENUM('asana', 'confluence', 'github', 'gmail', 'google-drive', 'jira', 'notion', 'slack', 'webConnector')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."o_auth_app_name_enum_old" AS ENUM('asana', 'confluence', 'github', 'gmail', 'google-drive', 'jira', 'notion', 'slack', 'webConnector')`);
