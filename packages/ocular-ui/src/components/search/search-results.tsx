...
export const AIResults = ({ content }) => (
  <div className={`hover:dark:bg-secondary-dark box-border flex h-10 w-64 min-w-10 cursor-pointer items-center justify-start rounded-full px-5 hover:bg-gray-100 bg-blue-100`}>
     {content}
  </div>
);
