...
const formSchema = z.object({
  apiToken: z
    ...
    .describe('The API token for Integration of Slack in Ocular'),
});
...
export default function SlackCard({ integration, authorizeApp }: Props) {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col space-y-3">
                      <FormLabel>Slack Integration API token</FormLabel>
                      <FormControl>
                        <Input
