...
const Results = ({ results }) => (
  <div className="mt-5 w-3/5 items-start justify-start">
    {results.items?.map((result) => (
      ...
      >
        <Image src="/Confluence.svg" alt={result.title} className="mr-4 size-10" width={10} height={10} />
        <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
          <div>
            ...
            <p className="font-regular line-clamp-3 text-sm" dangerouslySetInnerHTML={{ __html: result.htmlSnippet }}></p>
          </div>
